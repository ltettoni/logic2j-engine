 ...
 */
package org.logic2j.predsolver.exception;

/**
 * Exception used to indicate that a {@link org.logic2j.predsolver.model.Term} cannot be parsed from a text, of is used in a context where it should not.
 */
