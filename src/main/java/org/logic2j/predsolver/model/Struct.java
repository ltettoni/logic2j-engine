...
public class Struct extends Term {
    ...
    public Object getLHS() {
        if (this.arity != 2) {
            throw new InvalidTermException("Can't get the left-hand-side argument of \"" + this +
    ...
    public Object getRHS() {
        if (this.arity != 2) {
            throw new InvalidTermException("Can't get the right-hand-side argument of \"" + this +
                "\" (predicate arity is: " + getPredicateSignature() + ")");
        }
        return this.args[1];
    }
